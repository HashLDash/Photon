patterns = {
  ...
  ('num', 'operator', 'group'): expr,
  ('var', 'operator', 'num'): expr,
  ('var', 'operator', 'var'): expr,
  ('var', 'operator', 'expr'): expr,
  ('var', 'operator', 'group'): expr,
  ('expr', 'operator', 'num'): expr,
  ('expr', 'operator', 'var'): expr,
  ('expr', 'operator', 'expr'): expr,
  ('expr', 'operator', 'group'): expr,
  ('group', 'operator', 'num'): expr,
  ('group', 'operator', 'var'): expr,
  ('group', 'operator', 'expr'): expr,
  ('group', 'operator', 'group'): expr,
  ('operator', 'expr'): expr,
