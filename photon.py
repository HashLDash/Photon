...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "Interpreter mode not implemented yet. Please try executing a source file instead"
        )
        print("Or try:")
        print("    photon --help")
    ...
    if first == "build":
        ...
        try:
            ...
            print(
                "Please provide the package name. Ex:\n    photon logcat com.photon.example"
            )
    elif first == "set":
        ...
        if variable in ["defaultLang"]:
            if value in ["c", "d", "dart", "haxe", "js"]:
                ...
                print(
                    "Error: Invalid lang. Available langs are: c, d, dart, haxe and js"
                )
        else:
            print(
                "This setting is not available. Available parameters are:\n    defaultLang"
            )
        ...
        print(
            "    photon build [platform] Builds and runs the project for the target platform"
        )
        ...
        try:
            ...
            lang = "c"
        Interpreter(
            filename, lang=lang, standardLibs="@PHOTON_INSTALL_PATH" + "/Libs/"
        ).run()
